...
export default function Home() {
  ...
  return (
    <>
      <div className="absolute bg-[url('../../public/background.jpg')] bg-no-repeat bg-cover bg-top w-full min-h-screen" />
      <div className="flex flex-col items-center z-0 ">
        ...
        <section className="flex flex-col mt-32 items-center">
          ...
          <div className="text-3xl mt-8 font-normal">
            We got almost every major skill badge for you to equip in your
